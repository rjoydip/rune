...
function generateTerminal(sizes: PackageSize[], baseline: BaselineMap | null): string {
  ...
  lines.push("");
  lines.push("---");
  lines.push("**Legend:** " + INDICATORS.green + " size decreased ≥" + DEFAULT_THRESHOLD + "% · " + INDICATORS.yellow + " changed <" + DEFAULT_THRESHOLD + "% · " + INDICATORS.red + " increased ≥" + DEFAULT_THRESHOLD + "% (threshold per baseline record)");
